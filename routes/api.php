...
Route::prefix('v1')->middleware(['request_logs'])->group(function () {
    ...
    Route::get('google', [\App\Http\Controllers\Api\V1\AdminBackOffice\Auth\GoogleAuthController::class, 'redirectToGoogle']);
    Route::get('google/callback', [\App\Http\Controllers\Api\V1\AdminBackOffice\Auth\GoogleAuthController::class, 'handleGoogleCallback']);
